...
[source, shell]
----
git clone https://github.com/ultrastable-money/substrate.git
cd substrate
----
...
https://github.com/ultrastable-money/substrate/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/ultrastable-money/substrate/blob/master/LICENSE[LICENSE]
